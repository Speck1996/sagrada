...
public class EglomiseBrushTest {
    ...
    public void setUp(){
        ...
        demoCard = new EglomiseBrush("demo","demo","demo");
    ...
    public void testPlayerCommand(){
        ...
        Assert.assertEquals(new Dice(DiceColor.YELLOW, DiceShade.ONE), ToolCardTestUtilities.wpc.getSpaces()[0][1].getDice());
    ...
    public void testPayCardSinglePlayer()throws CardNotUsableException{
        demoCard.activateCard(ToolCardTestUtilities.player, new Dice(DiceColor.BLUE,DiceShade.THREE));
