...
public class DeepShadesTest {
    ...
    public void computeScoreTest() throws WindowSyntaxException {
        ObjCard card = new PairsShades("COF20", "Deep Shades", "Sets of 5 & 6 values anywhere", 2, DiceShade.FIVE, DiceShade.SIX);
        ...
        assertEquals(2, card.computeScore(wpc.getSpaces()));
    }
}